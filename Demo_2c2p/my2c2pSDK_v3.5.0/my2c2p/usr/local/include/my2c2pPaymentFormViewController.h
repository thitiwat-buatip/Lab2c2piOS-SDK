...
- (void)GCashPaymentDictionary:(NSDictionary *)dictionary AndViewController:(UIViewController *)controller;
...
@property (nonatomic, assign, readonly) My2c2pPaymentChannel currentPaymentChannel;   //current payment channel
